...
/*
#define INIT_BUTTONS	for(uint8_t i = 2; i < RECEIVER_QTY; i++)\
{\
	INIT_CHANNEL_BUTTON(i)\
}\
INIT_SPEC_BUTTONS
*/
...
/*
#define CREATE_BUTTONS		for(uint8_t i = 2; i < RECEIVER_QTY; i++)\
{\
	CREATE_CHANNEL_BUTTON(i)\
}\
CREATE_SPEC_BUTTONS
*/
...
/*
#define INIT_BUTTON_LIGHTS	for(uint8_t i = 2; i < RECEIVER_QTY; i++)\
{\
	INIT_CHANNEL_BUTTON_LIGHTS(i)\
}\
INIT_SPEC_BUTTONS_LIGHTS
*/
...
/*
#define UPDATE_BUTTON_LIGHTS	for(int i = 2; i < RECEIVER_QTY; i++)\
{\
	UPDATE_CHANNEL_BUTTON_LIGHTS(i)\
}\
UPDATE_SPEC_BUTTONS_LIGHTS
*/
